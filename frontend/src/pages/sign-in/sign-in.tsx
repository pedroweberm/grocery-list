...
export const SignIn = () => {
  ...
  const { value: username, handleChange: handleUsernameChange, isValid: isUsernameValid, onBlur: onUsernameBlur, isDone: isUsernameDone } = useFormField(location?.state?.username, usernameValidator)
  const { value: password, handleChange: handlePasswordChange, isValid: isPasswordValid, onBlur: onPasswordBlur, isDone: isPasswordDone } = useFormField('', passwordValidator)
  ...
  return (
    <MainContainer>
      <ContentContainer>
        <Title>Sign in to<br/>Your<br/>Account</Title>
        <LoginContainer>
          <LoginInputLabel>
            Username
          </LoginInputLabel>
