...
const ButtonText = styled.h2<{ primary: boolean; margin?: boolean }>`
  ...
  font-weight: 600;
  color: ${({ primary }) =>
    primary ? colors.purple.lightest : colors.purple.darkest};
...
const Button = styled.button<{
  ...
  border-color: ${({ primary }) =>
    primary ? colors.purple.darkest : colors.purple.darkest};
...
export const SmallButton = ({
  ...
  return (
    ...
    >
      ...
      {icon && <FiArrowRight size={26} color={colors.purple.lightest} />}
    </Button>
  );
};
